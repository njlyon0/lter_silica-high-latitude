## ------------------------------------------------------- ##
# Upload 02 Products to Google Drive
## ------------------------------------------------------- ##
...
# Define annual path
ann_path <- file.path("data", "stats-ready_annual")

# Define annual Drive folder
ann_url <- googledrive::as_id("https://drive.google.com/drive/u/0/folders/13oExoPA5-3xLq3XsQ1y6TcoaJD4oXCDO")
...
# Define annual path
mon_path <- file.path("data", "stats-ready_monthly")

# Define annual Drive folder
mon_url <- googledrive::as_id("https://drive.google.com/drive/u/0/folders/1MtHotTp_Jg-Lamgy_aF4THZAD29mTthc")
